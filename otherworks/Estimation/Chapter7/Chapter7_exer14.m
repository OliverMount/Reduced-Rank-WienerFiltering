...
% Program to plot the PDF of the Sample Variance estimator for the estimation
% of DC(A) in WGN
...
sig2esti(i)=sum((x).^2)/N; % M realization of a Sample Variance estimator(Random variable)
end
