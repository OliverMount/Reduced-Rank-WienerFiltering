...
p_gap=7; %16 (3,5) 32-31 64(3,7)  512-7  256 -3
Pilot_pos=1:p_gap:N;
...
Eb=1; EbNodB=0:5:10; No=1./10.^(EbNodB/10);  Es=log2(Z)*Eb;
...
legend('Perfect Channel','Time-domain Estimator','Comb-type Lowpass interpolated','Rank 3');
axis([0 10 10e-5 1]);
