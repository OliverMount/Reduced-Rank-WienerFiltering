...
%     E_capf=diag(H_capf);
    ...
    E_captRR=diag(H_captrr(:,2));% RR  TF estimator
...
ensemble_avg_captrr3=mean(pe_captrr3) % RAnk 3
...
% figure,hnd=semilogy(EBNO,ensemble_avg,'k',EBNO,ensemble_avg_capt_rr1,'k',EBNO,ensemble_avg_captrr,'k^-',EBNO,ensemble_avg_captrr3,'kp-',EBNO,ensemble_avg_capf,'k+');grid;
...
% ensemble_avg =
% 
%     0.2699    0.1645    0.1020    0.0601    0.0321    0.0160    0.0066    0.0030    0.0011    0.0004    0.0002
% 
% 
% ensemble_avg_capt_rr1 =
% 
%     0.4244    0.2928    0.1880    0.1035    0.0634    0.0332    0.0144    0.0071    0.0030    0.0010    0.0005
% 
% 
% ensemble_avg_captrr =
% 
%     0.4243    0.2927    0.1876    0.1045    0.0643    0.0347    0.0155    0.0083    0.0036    0.0013    0.0012
% 
% 
% ensemble_avg_captrr3 =
% 
%     0.4249    0.2925    0.1884    0.1036    0.0634    0.0337    0.0146    0.0071    0.0030    0.0010    0.0005
