...
tic;
noiter=2; % number of averaing iterations
len=10; % length of the transmiited sequence

del=26;  % Decision delay
M=25;  
D=25; % Dimension of the Subspace
...
for loop=1:noiter,   
    ...
    I(1,1)=0;  % To store the Eigen Values in PC
    ...
    r_dx=r_dx_mtx(del+1,:);   % Change here the decision variable
        ...
        for i=1:length(noisevar),
            ...
            MSE(loop,i)=h_ori(1)-MMSE_w'*Y*MMSE_w;
...
% Plot of MSE as a function of Rank

MSE_fullrank=mean(MSE)*ones(1,p);
figure,hnd=plot(1:p,MSE_fullrank,1:p,MSE_eig,'k>-',1:p,MSE_CS,'ko-',1:p,MSE_RR,'kp');
set(hnd(1),'linewidth',2);
axis([ 0 12 0 1.2]) 
