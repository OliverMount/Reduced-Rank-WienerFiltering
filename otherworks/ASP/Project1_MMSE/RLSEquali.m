% This program for Sequential Weighted Least squares (SWLS) equlaization
...
figure,hnd=semilogy(e);
hnd=title('J-min of Recursive Least Squares');
set(hnd,'fontsize',15); 
hnd=xlabel('Time (t)');
set(hnd,'fontsize',15); 
